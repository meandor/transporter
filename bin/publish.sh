...
check_configuration() {
    ...
    check_configured "ossrhUsername" "This is the username you use to authenticate with sonatype nexus (e.g. otto-de)"
    check_configured "ossrhPassword" "This is the password you use to authenticate with sonatype nexus (ask Guido or one of the developers)"
...
${SCRIPT_DIR}/gradlew release uploadArchives closeAndReleaseRepository